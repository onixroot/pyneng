...
attr_string = ', '.join(attr for attr in london_co[name].keys())
attr = input('Введите имя параметра (' + attr_string + '): ')
print(london_co[name].get(attr.lower(), 'Такого параметра нет'))